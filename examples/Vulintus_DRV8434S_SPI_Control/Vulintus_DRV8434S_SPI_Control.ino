/*  Vulintus_DRV8434S_SPI_Control.ino
...
void setup() {
  ...
  stepper.set_current_max(2500);        //Maximum possible current based on the maximum voltage on the VREF pin (Imax = VREF / 1.32 V/A).
  stepper.set_current(1200);             //Target output current.
